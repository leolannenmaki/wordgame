...
wordgame._jsbuild_.defineModule("client/domgame.js",function(exports,module,require,globals,undefined){
 /**
 * @constructor
 * @param {Game}
 */
var DomGame = function (game) {
    this.game = game;
    var Player = wordgame.require('common').Player;
/*$('#wordgame').bind('custom', function(event, param1, param2) {
  alert(param1 + "\n" + param2);
});
$('#wordgame').trigger('custom', ['Custom', 'Event']);
[
<div id=​"wordgame" style=​"display:​ none;​ ">​…​</div>​
]
*/
    $('#wordgame').bind('wordgame.add.player', function (e, name) {
        game.addPlayer(new Player(name));
    });
    $('#wordgame').bind('wordgame.start.game', function (e) {
        game.start();
    });
    $('#wordgame').bind('wordgame.set.tile', function (e, x, y, c) {
        game.set(game.whosTurn().getName(), x, y, c);
    });
    $('#wordgame').bind('wordgame.end.turn', function (e) {
        game.endTurn();
    });

};
DomGame.prototype.getGame = function() {
    return this.game
};
exports.DomGame = DomGame;
...
wordgame._jsbuild_.defineModule("client/jquery-1.4.2.js",function(exports,module,require,globals,undefined){
 /*!
...
wordgame._jsbuild_.defineModule("client/jquery.js",function(exports,module,require,globals,undefined){
 /*!
 * jQuery JavaScript Library v1.4.2
 * http://jquery.com/
 *
...
exports.DomGame = require('./client/domgame').DomGame;
